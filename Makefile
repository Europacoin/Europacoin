#############################################################################
# Makefile for building: EUROPA-qt
# Generated by qmake (2.01a) (Qt 4.8.5) on: Sat 4. Jan 21:59:03 2014
# Project:  EUROPA-qt.pro
# Template: app
# Command: c:\Qt\4.8.5\bin\qmake.exe USE_UPNP=- -o Makefile EUROPA-qt.pro
#############################################################################
...
Makefile: EUROPA-qt.pro  ../Qt/4.8.5/mkspecs/win32-g++/qmake.conf ../Qt/4.8.5/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_UPNP=- -o Makefile EUROPA-qt.pro
